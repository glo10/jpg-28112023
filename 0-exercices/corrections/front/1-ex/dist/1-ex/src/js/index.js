(() => {
  // 1-ex/src/js/sign-in.js
  var SignIn = class extends HTMLElement {
    /**
     * Constructor
     * @returns void
     */
    constructor() {
      ...
      this.render();
      this.inputs = [
        // Nos inputs element dans le DOM + message d'aide
        {
  ...
  // 1-ex/src/js/index.js
  window.onload = () => {
    document.querySelector("main").prepend(new sign_in_default());
  };
})();
